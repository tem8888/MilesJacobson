        ...
        fields: [
          {
            ...
            Можно вводить только часть имени. Нажав на реакцию под результатом поиска, оформляется бид (только в ЛС).`
          },
          {
            name: `!bid`,
          ...
          {
            name: `!end`,
            value: `Завершить трансферное окно для своего клуба. 
            Параметров не имеет.`,
            inline: true
          },
          {
            name: `!more`,
            value: `Команда вводится участниками перед дополнительными трансферами во время игровых ИД.  
            Параметров не имеет.`,
            inline: true
          },
          {
